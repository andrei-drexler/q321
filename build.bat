...
for %%f in (src\demo\*.cpp) do (
	...
	::clang-cl /std:c++latest /Oi /arch:IA32 --target=i686-pc-windows-msvc /QIfist /W1 /Zc:wchar_t /Zi /Gm- /O2 /Oy /GS- /Zc:inline /fp:fast /D "NDEBUG" /errorReport:prompt /GF /WX- /Zc:forScope /Gs1048576 /GR- /Gr /Gw /MD /FC /nologo /diagnostics:classic /Fo!obj_folder! /c %%f
